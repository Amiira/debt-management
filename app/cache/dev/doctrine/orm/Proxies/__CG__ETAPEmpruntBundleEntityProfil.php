...
namespace Proxies\__CG__\ETAP\EmpruntBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Profil extends \ETAP\EmpruntBundle\Entity\Profil implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'libelle', 'id');
        }
